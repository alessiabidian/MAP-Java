package com.example.lab06_gui.ui;
...
public class UI {
    ...
    private void adaugaPrietenie(){
        ...
        try{
            ...
            System.out.println("Nu au avut loc modificari!\n");
    ...
    private void adaugaUtilizator() {
        ...
        try {
            service.addUser(string2, string3, string4, string5); //if(service.addUser(ID, string2, string3, string4, string5, string6))
    ...
    private void modificaUtilizator(){
        ...
        try{
            service.updateUser(ID, string2, string3, string4, string5);
