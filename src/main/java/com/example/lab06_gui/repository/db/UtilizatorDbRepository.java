...
public class UtilizatorDbRepository implements Repository<Long, Utilizator> {
    ...
    public Utilizator findByTwoStrings(String emailUser, String passwordUser){
        ...
        try (Connection connection = DriverManager.getConnection(url, username, password);
             PreparedStatement statement = connection.prepareStatement("SELECT * from users where email like ? and parola like ?")){
    ...
    public Utilizator save(Utilizator entity) throws ValidationException {
        ...
        Utilizator u_existent = findByTwoStrings(entity.getEmail(), "%");
        if(u_existent!=null)
            throw new ValidationException("Email folosit deja!");
