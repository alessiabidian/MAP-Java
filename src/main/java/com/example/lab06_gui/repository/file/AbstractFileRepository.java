...
//            lines.forEach(linie -> {
//                E entity=extractEntity(Arrays.asList(linie.split(";"))); //!!!!!! trebe (linie) doar
//                super.save(entity);
//            });
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
     ...
     * @param linie//attributes
     * @return an entity of type E
     */
    public abstract E extractEntity(String linie); //(List<String> attributes);
